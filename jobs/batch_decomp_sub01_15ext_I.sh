...
LIVE_LOG=/rds/general/user/ag4916/ephemeral/thinfilm_logs_dir/sub01_15ext_I_live.txt
...
# Print job parameters
{
    ...
    echo "iterations     : 150"
    echo "Files:"
    echo "  /rds/general/project/thinfilmdata/live/forearm/raw_data/sub-01/day-01/sub-01_day-01_task-trap_ang-0_mvc-15ext_fing-I_time-1-3-20_run-01.otb+"
    echo "  /rds/general/project/thinfilmdata/live/forearm/raw_data/sub-01/day-01/sub-01_day-01_task-trap_ang-0_mvc-15ext_fing-I_time-1-3-20_run-02.otb+"
    echo ""

    # Copy input files to local SSD for fast I/O
    echo "=== Copying input files to local SSD ==="
    t_copy=$SECONDS
    ORIG_FILES=("/rds/general/project/thinfilmdata/live/forearm/raw_data/sub-01/day-01/sub-01_day-01_task-trap_ang-0_mvc-15ext_fing-I_time-1-3-20_run-01.otb+" "/rds/general/project/thinfilmdata/live/forearm/raw_data/sub-01/day-01/sub-01_day-01_task-trap_ang-0_mvc-15ext_fing-I_time-1-3-20_run-02.otb+")
    LOCAL_FILES=()
...
} 2>&1 | tee -a "$LIVE_LOG" > $TMPDIR/sub01_15ext_I.txt

cp $TMPDIR/sub01_15ext_I.txt $PBS_O_WORKDIR/jobs/job_outputs/sub01_15ext_I.txt
