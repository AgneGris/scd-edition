...
class MotorUnit:
    ...
    mean_fr: float = 0.0    # Mean firing rate (Hz)
    
    # Flags
    flagged_duplicate: bool = False
    flagged_quality: bool = False
    enabled: bool = True
...
@dataclass
class EditAction:
    """Represents an edit action for undo/redo."""
    action_type: str  # "add", "delete", "add_roi", "delete_roi", "recalculate"
    mu_id: int
...
class DataHandler:
    ...
    def _save_undo(self, action: EditAction):
